...
/// </summary>
/// <param name="Enabled">Whether charge control is currently switched on.</param>
...
/// <param name="SurplusWatts">The (averaged) solar surplus it is deciding on, or null when disabled.</param>
