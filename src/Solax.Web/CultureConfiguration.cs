...
internal static class CultureConfiguration
{
    ...
    // lives here instead, because Solax.Web is loaded by both the production host
    // (Solax.Worker) and the bUnit test host (Solax.Web.Tests), and both need the effect.
