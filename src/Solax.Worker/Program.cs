...
// SolaxControllerHostingExtensions for how that is enforced rather than merely intended.
...
// Assistant integration and the web UI. It lives in Solax.Hosting so that this file is a host and
// nothing more -- see that assembly for why each service is registered the way it is.
builder.AddSolaxController();

var host = builder.Build();

host.UseSolaxController();
...
log.LogInformation("SolaX Local Controller {Version} starting.", BuildInfo.Describe());
